...
def visiual_res(data: List[str]):
    console = Console()
    console.print(*data)


def visiual_all_res(header, data: List[List[str]]):
    console = Console()
...
if __name__ == '__main__':
    header = ["func", 'start', 'end', 'date_offset', 'name', 'phone', 'func cost_time']
    data_res = [['booking_a_train_ticket', '北京', '上海', '1', '张三', '13888888888', '15.003'],
